...
@section('content')
    ...
    <div class="relative bg-neutral-primary-soft overflow-x-auto mt-3 shadow-xs rounded-base border border-default">
        ...
        <!-- Table -->
        <div class="p-4">
            <table id="category-datatable" class="w-full text-sm text-left text-body">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="inline-flex items-center gap-3">
                                            <button class="edit-btn" data-id="{{ $category->id }}" data-name="{{ $category->name }}"
                                                ...
                                                data-route="{{ route('update-category', ':id') }}" data-modal-target="edit-modal"
                                                data-modal-toggle="edit-modal">
                                                <x-icons.edit class="text-fg-brand" />
                                            </button>
                                            <button class="delete-btn" data-id="{{ $category->id }}"
                                                data-route="{{ route('delete-category', ':id') }}" data-modal-target="delete-modal"
    ...
    <script>
        document.addEventListener('click', function (e) {
            ...
            if (editBtn) {
                ...
                const parent = editBtn.dataset.parent;
