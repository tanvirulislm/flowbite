...
@section('content')
            ...
            <form action="{{ route('create-party') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="hidden">
                        ...
                        <input type="text" name="type" id="create-type" value="customer"
                            class="w-full px-3 py-2 bg-neutral-secondary-medium border border-default-medium rounded-base">
                    </div>
        ...
        <div class="bg-white rounded-base shadow-sm w-full max-w-md p-6">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="hidden">
                        <label class="block mb-1 text-sm font-medium">Type</label>
                        <input type="text" name="type" id="edit-type" value="customer"
                            class="w-full px-3 py-2 bg-neutral-secondary-medium border border-default-medium rounded-base">
                    </div>
    ...
    {{-- View modal --}}
    <div id="view-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div class="bg-white rounded-base shadow-sm w-full max-w-md p-6">
